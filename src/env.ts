...
export const env = createEnv({
	...
	server: {
		...
		// Sewer Payment Stripe Price IDs (one-time)
		...
		// Sewer Payment Stripe Price IDs (recurring/subscription)
	...
	runtimeEnv: {
		...
		STRIPE_PRICE_SEWER_INTOWN_RESIDENTIAL: process.env.STRIPE_PRICE_SEWER_INTOWN_RESIDENTIAL,
		STRIPE_PRICE_SEWER_OUTTOWN_RESIDENTIAL: process.env.STRIPE_PRICE_SEWER_OUTTOWN_RESIDENTIAL,
		STRIPE_PRICE_SEWER_INTOWN_COMMERCIAL: process.env.STRIPE_PRICE_SEWER_INTOWN_COMMERCIAL,
		STRIPE_PRICE_SEWER_OUTTOWN_COMMERCIAL: process.env.STRIPE_PRICE_SEWER_OUTTOWN_COMMERCIAL,
		STRIPE_PRICE_SEWER_INTOWN_RESIDENTIAL_SUB: process.env.STRIPE_PRICE_SEWER_INTOWN_RESIDENTIAL_SUB,
		STRIPE_PRICE_SEWER_OUTTOWN_RESIDENTIAL_SUB: process.env.STRIPE_PRICE_SEWER_OUTTOWN_RESIDENTIAL_SUB,
		STRIPE_PRICE_SEWER_INTOWN_COMMERCIAL_SUB: process.env.STRIPE_PRICE_SEWER_INTOWN_COMMERCIAL_SUB,
		STRIPE_PRICE_SEWER_OUTTOWN_COMMERCIAL_SUB: process.env.STRIPE_PRICE_SEWER_OUTTOWN_COMMERCIAL_SUB,

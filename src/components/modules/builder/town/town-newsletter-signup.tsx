...
interface TownNewsletterSignupProps {
	title?: string;
	subtitle?: string;
	buttonText?: string;
}

export const TownNewsletterSignup = ({
	title = "Stay Connected with Harmony",
	subtitle = "Get the latest news, events, and town updates delivered to your inbox.",
	buttonText = "Subscribe",
}: TownNewsletterSignupProps) => {
	...
	return (
		<section className="py-16 bg-sage-deep text-white text-center">
			<div className="container mx-auto px-4">
				<h2 className="text-[28px] font-serif font-bold mb-3">
					{title}
				</h2>
				<p className="text-base text-white/85 mb-7">{subtitle}</p>
